---
title: Connecting LIVOX MID-360 & Raspberry Pi wired  
summary: LIVOX MID-360とRaspberry Piを同時に有線接続する設定
authors:
    - Keitaro Nakamura
date: 2026-4-30
---

# LIVOX MID-360 Raspberry Pi 同時有線接続 マニュアル
...
| :----: | :----: | :----: | :----: | :----: |
| livox-Raspi-switch | 192.168.1.50 | 255.255.255.0 | 192.168.1.1 | 192.168.1.1 |
